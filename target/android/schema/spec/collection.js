...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__17471__auto__,k19174,else__17472__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k19174,else__17472__auto__);
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__19173){
var self__ = this;
var G__19173__$1 = this;
return (new cljs.core.RecordIter((0),G__19173__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__17476__auto__,k__17477__auto__,G__19173){
var self__ = this;
var this__17476__auto____$1 = this;
var pred__19177 = cljs.core.keyword_identical_QMARK_;
var expr__19178 = k__17477__auto__;
if(cljs.core.truth_(pred__19177.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__19178))){
return (new schema.spec.collection.CollectionSpec(G__19173,self__.constructor,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__19177.call(null,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),expr__19178))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__19173,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__19177.call(null,new cljs.core.Keyword(null,"elements","elements",657646735),expr__19178))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor,G__19173,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__19177.call(null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__19178))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor,self__.elements,G__19173,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__17477__auto__,G__19173),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__17468__auto__,G__19173){
var self__ = this;
var this__17468__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor,self__.elements,self__.on_error,G__19173,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__19175){
return (new schema.spec.collection.CollectionSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__19175),new cljs.core.Keyword(null,"constructor","constructor",-1953928811).cljs$core$IFn$_invoke$arity$1(G__19175),new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(G__19175),new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__19175),null,cljs.core.dissoc.call(null,G__19175,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)),null));
});
...
var seq__19185_19189 = cljs.core.seq.call(null,coll);
...
var temp__4425__auto___19198 = cljs.core.seq.call(null,seq__19185_19189);
if(temp__4425__auto___19198){
var seq__19185_19199__$1 = temp__4425__auto___19198;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19185_19199__$1)){
var c__17658__auto___19200 = cljs.core.chunk_first.call(null,seq__19185_19199__$1);
var G__19201 = cljs.core.chunk_rest.call(null,seq__19185_19199__$1);
var G__19202 = c__17658__auto___19200;
var G__19203 = cljs.core.count.call(null,c__17658__auto___19200);
var G__19204 = (0);
