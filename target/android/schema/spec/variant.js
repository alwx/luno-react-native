...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__17457__auto__,k19200,else__17458__auto__){
var self__ = this;
var this__17457__auto____$1 = this;
var G__19202 = (((k19200 instanceof cljs.core.Keyword))?k19200.fqn:null);
switch (G__19202) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k19200,else__17458__auto__);
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__17462__auto__,k__17463__auto__,G__19199){
var self__ = this;
var this__17462__auto____$1 = this;
var pred__19203 = cljs.core.keyword_identical_QMARK_;
var expr__19204 = k__17463__auto__;
if(cljs.core.truth_(pred__19203.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__19204))){
return (new schema.spec.variant.VariantSpec(G__19199,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__19203.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__19204))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__19199,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__19203.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__19204))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__19199,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__19203.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__19204))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__19199,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__17463__auto__,G__19199),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__17454__auto__,G__19199){
var self__ = this;
var this__17454__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__19199,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__19201){
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__19201),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__19201),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__19201),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__19201),null,cljs.core.dissoc.call(null,G__19201,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)),null));
});
...
var args19207 = [];
var len__17899__auto___19210 = arguments.length;
var i__17900__auto___19211 = (0);
while(true){
if((i__17900__auto___19211 < len__17899__auto___19210)){
args19207.push((arguments[i__17900__auto___19211]));

var G__19212 = (i__17900__auto___19211 + (1));
i__17900__auto___19211 = G__19212;
continue;
} else {
}
break;
