...
var args21497 = [];
var len__17913__auto___21501 = arguments.length;
var i__17914__auto___21502 = (0);
while(true){
if((i__17914__auto___21502 < len__17913__auto___21501)){
args21497.push((arguments[i__17914__auto___21502]));

var G__21503 = (i__17914__auto___21502 + (1));
i__17914__auto___21502 = G__21503;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___21505 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__21496_SHARP_){
if(!((p1__21496_SHARP_ == null))){
if((false) || (p1__21496_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4425__auto___21505){
var not_reactive_21506 = temp__4425__auto___21505;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_21506);
} else {
}
} else {
}
