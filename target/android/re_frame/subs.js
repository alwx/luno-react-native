...
var args21480 = [];
var len__17899__auto___21484 = arguments.length;
var i__17900__auto___21485 = (0);
while(true){
if((i__17900__auto___21485 < len__17899__auto___21484)){
args21480.push((arguments[i__17900__auto___21485]));

var G__21486 = (i__17900__auto___21485 + (1));
i__17900__auto___21485 = G__21486;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___21488 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__21479_SHARP_){
if(!((p1__21479_SHARP_ == null))){
if((false) || (p1__21479_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
var not_reactive_21489 = temp__4425__auto___21488;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_21489);
} else {
}
} else {
}
