...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__21531){
...
return cljs.core.get_in.call(null,new_db,p1__21532_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__21533_SHARP_){
return cljs.core.get_in.call(null,db,p1__21533_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__21534__i = 0, G__21534__a = new Array(arguments.length -  2);
while (G__21534__i < G__21534__a.length) {G__21534__a[G__21534__i] = arguments[G__21534__i + 2]; ++G__21534__i;}
  in_paths = new cljs.core.IndexedSeq(G__21534__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__21535){
var f = cljs.core.first(arglist__21535);
arglist__21535 = cljs.core.next(arglist__21535);
var out_path = cljs.core.first(arglist__21535);
var in_paths = cljs.core.rest(arglist__21535);
