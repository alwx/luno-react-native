...
luno.android.core.wrapped_main_scene = (function luno$android$core$wrapped_main_scene(p__20940){
var map__20943 = p__20940;
...
var navigator = cljs.core.get.call(null,map__20943__$1,new cljs.core.Keyword(null,"navigator","navigator",2050004181));
...
});})(drawer,map__20943,map__20943__$1,navigator))
,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (drawer,map__20943,map__20943__$1,navigator){
...
luno.android.core.wrapped_about_scene = (function luno$android$core$wrapped_about_scene(p__20945){
...
return reagent.core.as_element.call(null,(function (){var pred__20953 = cljs.core._EQ_;
var expr__20954 = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(route__$1);
if(cljs.core.truth_(pred__20953.call(null,"main",expr__20954))){
...
if(cljs.core.truth_(pred__20953.call(null,"about",expr__20954))){
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__20954)].join('')));
}
}
})());
})], null)], null);
