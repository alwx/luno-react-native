 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__19160,p__19161){
var map__19166 = p__19160;
var map__19166__$1 = ((((!((map__19166 == null)))?((((map__19166.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19166.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19166):map__19166);
var schema__$1 = cljs.core.get.call(null,map__19166__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.call(null,map__19166__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__19167 = p__19161;
var map__19167__$1 = ((((!((map__19167 == null)))?((((map__19167.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19167.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19167):map__19167);
var params = map__19167__$1;
var subschema_checker = cljs.core.get.call(null,map__19167__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.call(null,map__19167__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache.call(null,cache,schema__$1,((function (map__19166,map__19166__$1,schema__$1,error_wrap,map__19167,map__19167__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__19166,map__19166__$1,schema__$1,error_wrap,map__19167,map__19167__$1,params,subschema_checker,cache){
return (function (x){
return cljs.core.deref.call(null,d).call(null,x);
});
;})(map__19166,map__19166__$1,schema__$1,error_wrap,map__19167,map__19167__$1,params,subschema_checker,cache))
});})(map__19166,map__19166__$1,schema__$1,error_wrap,map__19167,map__19167__$1,params,subschema_checker,cache))
,((function (map__19166,map__19166__$1,schema__$1,error_wrap,map__19167,map__19167__$1,params,subschema_checker,cache){
return (function (){
return subschema_checker.call(null,schema__$1,params);
});})(map__19166,map__19166__$1,schema__$1,error_wrap,map__19167,map__19167__$1,params,subschema_checker,cache))
);
if(cljs.core.truth_(error_wrap)){
return ((function (sub,map__19166,map__19166__$1,schema__$1,error_wrap,map__19167,map__19167__$1,params,subschema_checker,cache){
return (function (x){
...
;})(sub,map__19166,map__19166__$1,schema__$1,error_wrap,map__19167,map__19167__$1,params,subschema_checker,cache))
} else {
return sub;
}
});
