...
luno.shared.scenes.main.main_scene = (function luno$shared$scenes$main$main_scene(p__29502){
var map__29509 = p__29502;
...
var platform = cljs.core.get.call(null,map__29509__$1,new cljs.core.Keyword(null,"platform","platform",-1086422114));
var navigator = cljs.core.get.call(null,map__29509__$1,new cljs.core.Keyword(null,"navigator","navigator",2050004181));
var city_wrapper_fn = cljs.core.get.call(null,map__29509__$1,new cljs.core.Keyword(null,"city-wrapper-fn","city-wrapper-fn",-925052295));
var style = cljs.core.get.call(null,map__29509__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__29514),luno$shared$scenes$main$main_scene_$_iter__29511.call(null,cljs.core.chunk_rest.call(null,s__29512__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__29514),null);
}
} else {
var city = cljs.core.first.call(null,s__29512__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [luno.shared.components.city.city_component,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"city","city",-393302614),city,new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.get.call(null,style,new cljs.core.Keyword(null,"city-card","city-card",-1551546257)),new cljs.core.Keyword(null,"wrapper-fn","wrapper-fn",-274636345),city_wrapper_fn], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str("container-"),cljs.core.str(city)].join('')], null)),luno$shared$scenes$main$main_scene_$_iter__29511.call(null,cljs.core.rest.call(null,s__29512__$2)));
}
} else {
return null;
}
...
});})(data,cities,map__29509,map__29509__$1,platform,navigator,city_wrapper_fn,style))
,null,null));
});})(data,cities,map__29509,map__29509__$1,platform,navigator,city_wrapper_fn,style))
;
