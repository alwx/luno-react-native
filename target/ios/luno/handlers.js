...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"load-from-db","load-from-db",-1589655162),(function (db,p__21563){
var vec__21564 = p__21563;
var _ = cljs.core.nth.call(null,vec__21564,(0),null);
var model_type = cljs.core.nth.call(null,vec__21564,(1),null);
luno.db.load.call(null,model_type,((function (vec__21564,_,model_type){
...
});})(vec__21564,_,model_type))
);

return db;
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"load-from-db-city","load-from-db-city",-874216343),(function (db,p__21565){
var vec__21566 = p__21565;
var _ = cljs.core.nth.call(null,vec__21566,(0),null);
var data = cljs.core.nth.call(null,vec__21566,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,((function (vec__21566,_,data){
return (function (city){
var map__21567 = clojure.walk.keywordize_keys.call(null,cljs.core.js__GT_clj.call(null,city));
...
var city__$1 = map__21567__$1;
var name = cljs.core.get.call(null,map__21567__$1,new cljs.core.Keyword(null,"name","name",1843675177));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [name,city__$1], null);
});})(vec__21566,_,data))
,data)));
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"load-weather","load-weather",786153970),(function (db,p__21571){
var vec__21572 = p__21571;
var _ = cljs.core.nth.call(null,vec__21572,(0),null);
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"load-weather-success","load-weather-success",8344124),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__21569_SHARP_,city], null)], null));
});})(vec__21572,_,city))
,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),((function (vec__21572,_,city){
return (function (p1__21570_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"load-weather-failure","load-weather-failure",-1634054401),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__21570_SHARP_,city], null)], null));
});})(vec__21572,_,city))
], null));

return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"loading?","loading?",1905707049),true);
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"load-weather-success","load-weather-success",8344124),(function (db,p__21573){
var vec__21574 = p__21573;
var _ = cljs.core.nth.call(null,vec__21574,(0),null);
var vec__21575 = cljs.core.nth.call(null,vec__21574,(1),null);
var response = cljs.core.nth.call(null,vec__21575,(0),null);
var city = cljs.core.nth.call(null,vec__21575,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"load-weather-failure","load-weather-failure",-1634054401),(function (db,p__21576){
var vec__21577 = p__21576;
var _ = cljs.core.nth.call(null,vec__21577,(0),null);
var vec__21578 = cljs.core.nth.call(null,vec__21577,(1),null);
var e = cljs.core.nth.call(null,vec__21578,(0),null);
var city = cljs.core.nth.call(null,vec__21578,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"load-city-image","load-city-image",-595084832),(function (db,p__21581){
var vec__21582 = p__21581;
var _ = cljs.core.nth.call(null,vec__21582,(0),null);
var city = cljs.core.nth.call(null,vec__21582,(1),null);
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"load-city-image-success","load-city-image-success",-770767593),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__21579_SHARP_,city], null)], null));
});})(vec__21582,_,city))
,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),((function (vec__21582,_,city){
return (function (p1__21580_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"load-city-image-failure","load-city-image-failure",-1243284689),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__21580_SHARP_,city], null)], null));
});})(vec__21582,_,city))
], null));

return db;
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"load-city-image-success","load-city-image-success",-770767593),(function (db,p__21583){
var vec__21584 = p__21583;
var _ = cljs.core.nth.call(null,vec__21584,(0),null);
var vec__21585 = cljs.core.nth.call(null,vec__21584,(1),null);
var response = cljs.core.nth.call(null,vec__21585,(0),null);
var city = cljs.core.nth.call(null,vec__21585,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"load-city-image-failure","load-city-image-failure",-1243284689),(function (db,p__21586){
var vec__21587 = p__21586;
var _ = cljs.core.nth.call(null,vec__21587,(0),null);
var vec__21588 = cljs.core.nth.call(null,vec__21587,(1),null);
var e = cljs.core.nth.call(null,vec__21588,(0),null);
var city = cljs.core.nth.call(null,vec__21588,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"set-android-drawer","set-android-drawer",-459616806),luno.handlers.validate_schema_mw,(function (db,p__21589){
var vec__21590 = p__21589;
var _ = cljs.core.nth.call(null,vec__21590,(0),null);
var value = cljs.core.nth.call(null,vec__21590,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"set-shared-tab","set-shared-tab",415217295),luno.handlers.validate_schema_mw,(function (db,p__21591){
var vec__21592 = p__21591;
var _ = cljs.core.nth.call(null,vec__21592,(0),null);
var value = cljs.core.nth.call(null,vec__21592,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"delete-city","delete-city",391403040),(function (db,p__21593){
var vec__21594 = p__21593;
var _ = cljs.core.nth.call(null,vec__21594,(0),null);
var city = cljs.core.nth.call(null,vec__21594,(1),null);
...
return cljs.core.update.call(null,db,new cljs.core.Keyword(null,"data","data",-232669377),((function (vec__21594,_,city){
return (function (v){
