...
while (G__21532__i < G__21532__a.length) {G__21532__a[G__21532__i] = arguments[G__21532__i + 0]; ++G__21532__i;}
  args = new cljs.core.IndexedSeq(G__21532__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__21533){
...
return cljs.core.get_in.call(null,new_db,p1__21534_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__21535_SHARP_){
return cljs.core.get_in.call(null,db,p1__21535_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__21536__i = 0, G__21536__a = new Array(arguments.length -  2);
while (G__21536__i < G__21536__a.length) {G__21536__a[G__21536__i] = arguments[G__21536__i + 2]; ++G__21536__i;}
  in_paths = new cljs.core.IndexedSeq(G__21536__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__21537){
var f = cljs.core.first(arglist__21537);
arglist__21537 = cljs.core.next(arglist__21537);
var out_path = cljs.core.first(arglist__21537);
var in_paths = cljs.core.rest(arglist__21537);
