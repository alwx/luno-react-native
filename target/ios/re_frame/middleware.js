...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__21547){
...
return cljs.core.get_in.call(null,new_db,p1__21548_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__21549_SHARP_){
return cljs.core.get_in.call(null,db,p1__21549_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__21550__i = 0, G__21550__a = new Array(arguments.length -  2);
while (G__21550__i < G__21550__a.length) {G__21550__a[G__21550__i] = arguments[G__21550__i + 2]; ++G__21550__i;}
  in_paths = new cljs.core.IndexedSeq(G__21550__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__21551){
var f = cljs.core.first(arglist__21551);
arglist__21551 = cljs.core.next(arglist__21551);
var out_path = cljs.core.first(arglist__21551);
var in_paths = cljs.core.rest(arglist__21551);
